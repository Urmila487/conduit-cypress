...
function merge(target, source, options) {
  ...
  if (options !== null && options !== void 0 && options.replaceArrays && isSourceArray) return source;
  ...
  return entries(source).reduce((result, [key, value]) => {
    ...
    value = skipMerge.includes(k) ? value : merge(result === null || result === void 0 ? void 0 : result[key], value, options);
